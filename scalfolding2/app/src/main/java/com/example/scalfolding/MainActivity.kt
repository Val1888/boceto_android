...
fun Aplicacion(modifier: Modifier) {
    fun al_pulsar_el_carrito(): Unit{
        Log.v("Aplicacion", "Se ha pulsado el boton y utilizado la funcion el pulsar el carrito")
    }
...
@Composable
fun BotonFlotante (el_pusho_picar: () -> Unit) {
    FloatingActionButton(onClick = el_pusho_picar) {
